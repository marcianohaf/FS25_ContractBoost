...
function MissionBorrow:addFillItemsToMissionTools()
    if ContractBoost.debug then Logging.info(MOD_NAME..':BORROW :: fillMissionTools') end
    ...
    if ContractBoost.debug then Logging.info(MOD_NAME..':BORROW :: fillMissionTools complete') end
end